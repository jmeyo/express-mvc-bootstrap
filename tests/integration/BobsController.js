...
/**
 *  Bobs Integration Test
 *  Created by create-test script @ Wed Mar 16 2011 14:32:12 GMT+0000 (GMT)
 **/
/**
 * Dependencies
 */
var assert = require('assert'), inflection = require('lib/inflection'), should = require('should'); 

// Force into test environment
...
module.exports = {
		...
		'Viewing a deleted object returns a 500 error': function(done){  // This should really be a 404 :(			
